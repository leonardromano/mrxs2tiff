...
mrxs2tiff(folder, dir_out=dir_out, opt_bioformats2raw=opt_bioformats2raw, opt_raw2ometiff=opt_raw2ometiff)
...
# Optional arguments don't need to be specified, possible call signatures are given below
mrxs2tiff(path, fname, dir_out, opt_bioformats2raw=opt_bioformats2raw, opt_raw2ometiff=opt_raw2ometiff)
